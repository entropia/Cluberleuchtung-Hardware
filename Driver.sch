...
AR Path="/5A4C442B/5A7753B7" Ref="R?"  Part="1" 
...
AR Path="/5A4C442B/5A77745B" Ref="C?"  Part="1" 
...
AR Path="/5A4C442B/5A777BDD" Ref="#PWR043"  Part="1" 
F 0 "#PWR043" H 1500 2050 50  0001 C CNN
...
AR Path="/5A4C442B/5A777CD4" Ref="C?"  Part="1" 
...
AR Path="/5A4C442B/5A777CDA" Ref="#PWR044"  Part="1" 
F 0 "#PWR044" H 2700 2050 50  0001 C CNN
...
AR Path="/5A4C442B/5A777FA3" Ref="#PWR045"  Part="1" 
...
AR Path="/5A4C442B/5A77816D" Ref="C?"  Part="1" 
...
AR Path="/5A4C442B/5A77899A" Ref="L?"  Part="1" 
...
AR Path="/5A4C442B/5A7789F9" Ref="D?"  Part="1" 
...
AR Path="/5A4C442B/5A778B62" Ref="#PWR046"  Part="1" 
...
AR Path="/5A4C442B/5A779AD3" Ref="J?"  Part="1" 
...
AR Path="/5A4C442B/5A77A2E1" Ref="R?"  Part="1" 
...
AR Path="/5A4C442B/5A77A9CB" Ref="#PWR047"  Part="1" 
F 0 "#PWR047" H 3450 2050 50  0001 C CNN
...
AR Path="/5A4C442B/5A77D10E" Ref="C?"  Part="1" 
...
AR Path="/5A4C442B/5A77D43C" Ref="#PWR?"  Part="1" 
...
AR Path="/5A4C442B/5A77E620" Ref="U?"  Part="1" 
...
U 1 1 5A83A3D8
P 5700 950
AR Path="/5A4C3F5F/5A83A3D8" Ref="D?"  Part="1" 
AR Path="/5A4C442B/5A83A3D8" Ref="D?"  Part="1" 
F 0 "D?" H 5700 1320 50  0000 C CNN
F 1 "LED_ARGB" H 5700 600 50  0000 C CNN
...
U 1 1 5A83A3DF
P 5700 750
AR Path="/5A4C3F5F/5A83A3DF" Ref="#PWR?"  Part="1" 
AR Path="/5A4C442B/5A83A3DF" Ref="#PWR?"  Part="1" 
...
U 1 1 5A83A3E9
P 6100 1600
AR Path="/5A4C3F5F/5A83A3E9" Ref="#PWR?"  Part="1" 
AR Path="/5A4C442B/5A83A3E9" Ref="#PWR?"  Part="1" 
...
U 1 1 5A83A3EF
P 5700 2100
AR Path="/5A4C3F5F/5A83A3EF" Ref="#PWR?"  Part="1" 
AR Path="/5A4C442B/5A83A3EF" Ref="#PWR?"  Part="1" 
...
U 1 1 5A83A3F5
P 5300 2600
AR Path="/5A4C3F5F/5A83A3F5" Ref="#PWR?"  Part="1" 
AR Path="/5A4C442B/5A83A3F5" Ref="#PWR?"  Part="1" 
...
U 1 1 5A83A3FE
P 5200 2400
AR Path="/5A4C3F5F/5A83A3FE" Ref="Q?"  Part="1" 
AR Path="/5A4C442B/5A83A3FE" Ref="Q?"  Part="1" 
F 0 "Q?" H 5400 2475 50  0000 L CNN
F 1 "DMG2302UK" H 5400 2400 50  0000 L CNN
F 2 "TO_SOT_Packages_SMD:SOT-23" H 5400 2325 50  0001 L CIN
F 3 "https://www.diodes.com/assets/Datasheets/DMG2302UK.pdf" H 5200 2400 50  0001 L CNN
F 4 "https://www.digikey.com/product-detail/en/diodes-incorporated/DMG2302UK-7/DMG2302UK-7DICT-ND/6010163" H 5200 2400 60  0001 C CNN "Digikey"
	1    5200 2400
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5A83A406
P 5600 1900
AR Path="/5A4C3F5F/5A83A406" Ref="Q?"  Part="1" 
AR Path="/5A4C442B/5A83A406" Ref="Q?"  Part="1" 
F 0 "Q?" H 5800 1975 50  0000 L CNN
F 1 "DMG2302UK" H 5800 1900 50  0000 L CNN
F 2 "TO_SOT_Packages_SMD:SOT-23" H 5800 1825 50  0001 L CIN
F 3 "https://www.diodes.com/assets/Datasheets/DMG2302UK.pdf" H 5600 1900 50  0001 L CNN
F 4 "https://www.digikey.com/product-detail/en/diodes-incorporated/DMG2302UK-7/DMG2302UK-7DICT-ND/6010163" H 5600 1900 60  0001 C CNN "Digikey"
	1    5600 1900
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5A83A40E
P 6000 1400
AR Path="/5A4C3F5F/5A83A40E" Ref="Q?"  Part="1" 
AR Path="/5A4C442B/5A83A40E" Ref="Q?"  Part="1" 
F 0 "Q?" H 6200 1475 50  0000 L CNN
F 1 "DMG2302UK" H 6200 1400 50  0000 L CNN
F 2 "TO_SOT_Packages_SMD:SOT-23" H 6200 1325 50  0001 L CIN
F 3 "https://www.diodes.com/assets/Datasheets/DMG2302UK.pdf" H 6000 1400 50  0001 L CNN
F 4 "https://www.digikey.com/product-detail/en/diodes-incorporated/DMG2302UK-7/DMG2302UK-7DICT-ND/6010163" H 6000 1400 60  0001 C CNN "Digikey"
	1    6000 1400
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 1 "165" V 4800 1400 50  0000 C CNN
...
F 1 "165" V 4800 1900 50  0000 C CNN
...
F 1 "165" V 4800 2400 50  0000 C CNN
